      ...
      <div className="container px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20">
          ...
          <Card className="bg-accent/5 border-accent/20">
            <CardContent className="p-8">
              <h3 className="text-2xl font-display font-medium text-accent mb-4">Our Vision</h3>
              <p className="text-base text-muted-foreground leading-relaxed font-light">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            <h3 className="text-3xl font-display font-medium mb-6">Our History</h3>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border mb-12">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-display font-medium mb-4">Our Core Values</h3>
            <p className="text-muted-foreground font-light">The principles that guide our work every day.</p>
          </div>
